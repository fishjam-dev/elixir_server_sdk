...
Elixir server SDK for [Fishjam](https://github.com/jellyfish-dev/jellyfish).
...
(for more information see [Fishjam docs](https://jellyfish-dev.github.io/jellyfish-docs/getting_started/authentication))
``` config.exs
